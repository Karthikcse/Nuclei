...
public class ScTaxonomysMessage {
	@XmlElement(name = "status")
	public ResponseStatus status;

	private Iterable<Map<String, Object>> entities;

	public ScTaxonomysMessage() {
		super();
	}

	public ScTaxonomysMessage(ResponseStatus status,
	...
	public Iterable<Map<String, Object>> getScTaxonomy() {
		return entities;
	}
