...
{"statements":[{"statement":"CREATE(n:ServiceCatalogueVersion{props})RETURN id(n)", "parameters":{"props":{"UUID":70001, "version":"4.1"}}}]}
{"statements":[{"statement":"CREATE(n:ServiceCatalogueVersion{props})RETURN id(n)", "parameters":{"props":{"UUID":70002, "version":"5.7"}}}]}

//ScTaxonomy
{"statements":[{"statement":"CREATE(n:ScTaxonomy{props})RETURN id(n)", "parameters":{"props":{"UUID":80001, "taxName":"mysql server", "version":"5.7"}}}]}
{"statements":[{"statement":"CREATE(n:ScTaxonomy{props})RETURN id(n)", "parameters":{"props":{"UUID":80002, "taxName":"OS", "value":"RHEL", "version":"6.1"}}}]}
...
{"statements":[{"statement":"CREATE(n:ScTaxonomy{props})RETURN id(n)", "parameters":{"props":{"UUID":80004, "taxName":"mysql server", "version":"4.1"}}}]}
